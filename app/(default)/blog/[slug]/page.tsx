  ...
  return (
    <section className="relative">
      ...
      <div className="mx-auto max-w-6xl px-4 sm:px-6">
        <div className="flex flex-col md:flex-row md:justify-between pb-12 pt-32 md:pb-20 md:pt-40 gap-8">
          {/* Left content */}
          <div className="w-full md:max-w-3xl overflow-x-hidden">
            <article>
              {/* Section header */}
