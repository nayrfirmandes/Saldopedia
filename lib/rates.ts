...
export const SUPPORTED_CRYPTOS = {
  ...
  'polygon-ecosystem-token': { symbol: 'MATIC', name: 'Polygon', nowpayments: 'maticmainnet' },
...
export const CACHE_TTL_SECONDS = 600; // 10 minutes to avoid CoinGecko rate limits
