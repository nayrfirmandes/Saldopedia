...
export default function CryptoCard({
  ...
  return (
    <div className="group relative rounded-xl border border-gray-100 bg-white p-4 shadow-sm hover:border-orange-300 md:p-5 dark:border-gray-700 dark:bg-gray-800 dark:hover:border-orange-500/40 card-telegram">
      {/* Badge */}
      {badge && (
