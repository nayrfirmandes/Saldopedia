        ...
        <div className="relative h-6 w-6">
          ...
          >
            <defs>
              <mask id="moonMask">
                ...
                <circle 
                  ...
                  fill="black"
                  style={{
                    transition: 'r 0.8s cubic-bezier(0.34, 1.56, 0.64, 1) 0.1s',
                  }}
                />
              </mask>
            </defs>
            <circle 
              ...
              mask="url(#moonMask)"
              style={{
                transition: 'r 0.7s cubic-bezier(0.34, 1.56, 0.64, 1)',
          ...
          >
            ...
            {sunRays.map((ray, index) => (
              <circle
                ...
                cy={isDark ? ray.cy : 12}
                r={isDark ? 1.5 : 0}
                className={isAnimating && isDark ? 'animate-shimmer' : ''}
                style={{
                  transition: 'cx 0.6s cubic-bezier(0.34, 1.56, 0.64, 1), cy 0.6s cubic-bezier(0.34, 1.56, 0.64, 1), r 0.6s cubic-bezier(0.34, 1.56, 0.64, 1)',
                  transformOrigin: 'center'
                }}
              />
            ))}
