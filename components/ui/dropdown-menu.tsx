...
export default function DropdownMenu() {
  ...
  return (
    <Menu as="div" className="relative">
      ...
      <Menu.Items className="absolute right-0 mt-2 w-48 origin-top-right rounded-lg bg-white shadow-lg ring-1 ring-black/5 focus:outline-none dark:bg-gray-800 dark:ring-gray-700 dropdown-telegram show">
        <div className="p-1">
          <Menu.Item>
            {({ active }) => (
              <Link
